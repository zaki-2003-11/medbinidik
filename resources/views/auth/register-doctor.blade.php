<x-guest-layout>
    ...
    <form method="POST" action="{{ route('doctor.register.store') }}">
        ...
        <div class="mt-4">
            ...
            <select name="gender" class="block mt-1 w-full rounded-md border-gray-300">
        ...
        <div class="mt-4">
            ...
            <select name="specialty_id" class="block mt-1 w-full rounded-md border-gray-300">
        ...
        <div class="mt-4">
            ...
            <x-text-input class="block mt-1 w-full" type="text" name="national_id" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-text-input class="block mt-1 w-full" type="text" name="license_number" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-text-input class="block mt-1 w-full" type="number" name="years_experience" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-text-input class="block mt-1 w-full" type="number" step="0.01" name="consultation_fee" />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-text-input class="block mt-1 w-full" type="password" name="password_confirmation" />
        </div>
